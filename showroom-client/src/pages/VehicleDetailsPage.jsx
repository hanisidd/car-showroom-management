...
export default function VehicleDetailsPage() {
  ...
  const fuelName = typeof vehicle.fuel_type === 'object' ? vehicle.fuel_type?.name : (vehicle.fuel_type || 'Petrol');
  ...
  const handleTestDriveSubmit = async (e) => {
    ...
    try {
      ...
      alert(err.response?.data?.message || 'Failed to schedule test drive. Please try again.');
    } finally {
    ...
    <div className="min-h-screen bg-[#09090b] text-zinc-100 antialiased flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-8 pt-28 pb-20 text-left flex-1 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Main Left Column: Image Gallery & Detailed Specs */}
          <div className="lg:col-span-2 space-y-8">
            {/* Gallery Viewport with Navigation Arrows */}
            <div className="space-y-3">
                ...
                {images.length > 1 && (
                  <>
                    ...
                    <button
                      ...
                      className="absolute right-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-black/70 hover:bg-black text-white border border-white/10 backdrop-blur-md transition-all opacity-80 hover:opacity-100 hover:scale-110 shadow-lg"
                      title="Next Image"
                    >
              ...
              {/* Drag-to-Scroll Thumbnails Strip (Scrollbar Hidden) */}
              {images.length > 1 && (
                <div 
            ...
            <div className="glass-card p-6 rounded-3xl space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm border-t border-zinc-800/80 pt-4">
                ...
                <div className="flex justify-between py-2 border-b border-zinc-800/40">
                  ...
                  <span className="text-white font-medium">{vehicle.body_type || 'SUV'}</span>
                </div>
                <div className="flex justify-between py-2 border-b border-zinc-800/40">
          ...
          {/* Right Column: Book Test Drive / Contact Card */}
